...
namespace ImperaPlus.GeneratedClient
{
    ...
    [GeneratedCode("NSwag", "7.1.6162.22205")]
    public partial class AccountClient : ImperaHttpClient
    {
        ...
        public async Task<LoginResponseModel> ExchangeAsync(string grant_type, string username, string password, CancellationToken cancellationToken)
        {
          ...
          var content_ = new MultipartFormDataContent();
              if (grant_type != null)
                  content_.Add(new StringContent(grant_type.ToString()), "grant_type");
              if (username != null)
                  content_.Add(new StringContent(username.ToString()), "username");
              if (password != null)
                  content_.Add(new StringContent(password.ToString()), "password");
