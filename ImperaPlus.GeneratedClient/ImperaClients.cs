...
namespace ImperaPlus.GeneratedClient
{
    ...
    public partial class AccountClient : ImperaHttpClient
    {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "400") 
                        {
                            ...
                            {
                                throw new ImperaPlusException("Could not deserialize the response body.", status_, responseData_, headers_, exception_);
                            }
        ...
        public async System.Threading.Tasks.Task<ManageInfoViewModel> GetManageInfoAsync(string returnUrl, bool? generateState, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (generateState != null) urlBuilder_.Append("generateState=").Append(System.Uri.EscapeDataString(System.Convert.ToString(generateState, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<ExternalLoginViewModel>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
    ...
    public partial class AllianceClient : ImperaHttpClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ImperaPlusException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<AllianceSummary> GetAllAsync()
        {
        ...
        /// <exception cref="ImperaPlusException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<AllianceSummary> GetAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        public async System.Threading.Tasks.Task<Alliance> GetAsync(System.Guid allianceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{allianceId}", System.Uri.EscapeDataString(System.Convert.ToString(allianceId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class GameClient : ImperaHttpClient
    {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<GameSummary>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
        ...
        public async System.Threading.Tasks.Task<List<GameChatMessage>> GetMessagesAsync(long gameId, bool? isPublic, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{gameId}", System.Uri.EscapeDataString(System.Convert.ToString(gameId, System.Globalization.CultureInfo.InvariantCulture)));
            if (isPublic != null) urlBuilder_.Append("isPublic=").Append(System.Uri.EscapeDataString(System.Convert.ToString(isPublic, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<GameChatMessage>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<LadderSummary>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<MapTemplateDescriptor>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<Message>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<FolderInformation>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<NewsItem>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<TournamentSummary>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<TournamentTeam>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<List<UserReference>>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
