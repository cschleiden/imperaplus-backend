...
namespace ImperaPlus.Application
{
    ...
    public class AutoMapperConfig : Profile
    {
        ...
        {
            this.CreateMap<Domain.Games.Game, DTO.Games.GameSummary>()
            ...
            this.CreateMap<Domain.Games.Game, DTO.Games.GameActionResult>()
            ...
            this.CreateMap<Domain.Games.Game, DTO.Games.Game>()
                .ForMember(x => x.Id, c => c.MapFrom(x => x.Id))
                .ForMember(x => x.Name, c => c.MapFrom(x => x.Name))
                .ForMember(x => x.HasPassword, c => c.MapFrom(x => x.IsPasswordProtected))
                .ForMember(x => x.Type, c => c.MapFrom(x => (DTO.Games.GameType)x.Type))
            ...
            this.CreateMap<Domain.Games.Chat.GameChatMessage, DTO.Games.Chat.GameChatMessage>()
            ...
            // History
            this.CreateMap<Domain.Games.History.HistoryGameTurn, DTO.Games.History.HistoryTurn>()
            ...
            this.CreateMap<Domain.Games.History.HistoryEntry, DTO.Games.History.HistoryEntry>();
            this.CreateMap<Domain.Games.History.HistoryAction, DTO.Games.History.HistoryAction>();

            this.CreateMap<Domain.Games.GameOptions, DTO.Games.GameOptions>()
            ...
            this.CreateMap<DTO.Games.GameOptions, Domain.Games.GameOptions>()
            ...
            this.CreateMap<Domain.Games.Map, DTO.Games.Map.Map>();

            this.CreateMap<Domain.Games.Country, DTO.Games.Map.Country>()
            ...
            this.CreateMap<Domain.Games.Player, DTO.Games.PlayerSummary>()
                .ForMember(x => x.UserId, c => c.MapFrom(x => x.UserId))
                .ForMember(x => x.Name, c => c.MapFrom(x => x.User.UserName))
                .ForMember(x => x.State, c => c.MapFrom(x => (DTO.Games.PlayerState)x.State))
                .ForMember(x => x.Outcome, c => c.MapFrom(x => (DTO.Games.PlayerOutcome)x.Outcome))
            ...
            this.CreateMap<Domain.Games.Team, DTO.Games.Team>();
            this.CreateMap<Domain.Games.Team, DTO.Games.TeamSummary>();

            this.CreateMap<Domain.Map.MapTemplate, DTO.Games.Map.MapTemplate>();
            this.CreateMap<Domain.Map.MapTemplate, DTO.Games.Map.MapTemplateDescriptor>()
                .ForMember(x => x.IsActive, c => c.MapFrom(_ => true));
            this.CreateMap<Domain.Map.MapTemplateDescriptor, DTO.Games.Map.MapTemplateDescriptor>();

            this.CreateMap<Domain.Enums.VictoryConditionType, DTO.Games.VictoryConditionType>();
            this.CreateMap<Domain.Enums.VictoryConditionType, DTO.Games.VictoryConditionType>().ReverseMap();
            this.CreateMap<Domain.Enums.VisibilityModifierType, DTO.Games.VisibilityModifierType>();
            this.CreateMap<Domain.Enums.VisibilityModifierType, DTO.Games.VisibilityModifierType>().ReverseMap();

            this.CreateMap<Domain.Map.CountryTemplate, DTO.Games.Map.CountryTemplate>();
            this.CreateMap<Domain.Map.CountryTemplate, string>()
                .ConvertUsing(x => x.Identifier.ToString());
            this.CreateMap<Domain.Map.Connection, DTO.Games.Map.Connection>();
            this.CreateMap<Domain.Map.Continent, DTO.Games.Map.Continent>();

            this.CreateMap<Domain.Chat.ChatMessage, DTO.Chat.ChatMessage>()
            ...
            this.CreateMap<Domain.Chat.Channel, DTO.Chat.ChannelInformation>()
            ...
            this.CreateMap<Domain.News.NewsContent, DTO.News.NewsContent>();

            this.CreateMap<Domain.News.NewsEntry, DTO.News.NewsItem>()
                .ForMember(x => x.DateTime, x => x.MapFrom(ne => ne.CreatedAt))
                .ForMember(x => x.PostedBy, x => x.MapFrom(ne => ne.CreatedBy.UserName));

            this.CreateLadderMapping();
            this.CreateTournamentMapping();
            this.CreateMessageMapping();
            this.CreateUserMapping();
            this.CreateAllianceMapping();
        }

        private void CreateAllianceMapping()
        {
            this.CreateMap<Domain.Alliances.Alliance, DTO.Alliances.AllianceSummary>()
                .ForMember(x => x.NumberOfMembers, x => x.MapFrom(a => a.Members.Count()))
                .ForMember(x => x.Admins, x => x.MapFrom(a => a.Administrators));

            this.CreateMap<Domain.Alliances.Alliance, DTO.Alliances.Alliance>()
                .ForMember(x => x.NumberOfMembers, x => x.MapFrom(a => a.Members.Count()))
                .ForMember(x => x.Admins, x => x.MapFrom(a => a.Administrators));

            this.CreateMap<Domain.Alliances.AllianceJoinRequest, DTO.Alliances.AllianceJoinRequest>();
            this.CreateMap<Domain.Alliances.AllianceJoinRequestState, DTO.Alliances.AllianceJoinRequestState>();
        }

        private void CreateLadderMapping()
        {
            // Standing is mapped separately
            this.CreateMap<Domain.Ladders.Ladder, DTO.Ladder.LadderSummary>()
                .ForMember(x => x.Standing, x => x.Ignore())
                .ForMember(x => x.IsQueued, x => x.Ignore())
                .ForMember(x => x.QueueCount, x => x.MapFrom(l => l.Queue.Count()));


            this.CreateMap<Domain.Ladders.Ladder, DTO.Ladder.Ladder>()
                .ForMember(x => x.Standing, x => x.Ignore())
        ...
        private void CreateTournamentMapping()
        {
            ...
            this.CreateMap<Domain.Tournaments.TournamentGroup, DTO.Tournaments.TournamentGroup>();
            this.CreateMap<Domain.Tournaments.TournamentParticipant, DTO.Users.UserReference>()
                .ForMember(x => x.Id, x => x.MapFrom(p => p.UserId))
                .ForMember(x => x.Name, x => x.MapFrom(p => p.User.UserName));

            this.CreateMap<Domain.Tournaments.TournamentPairing, DTO.Tournaments.TournamentPairing>();

            this.CreateMap<Domain.Tournaments.TournamentState, DTO.Tournaments.TournamentState>();
            this.CreateMap<Domain.Tournaments.TournamentTeamState, DTO.Tournaments.TournamentTeamState>();
        }

        private void CreateMessageMapping()
        {
            this.CreateMap<Domain.Messages.Message, DTO.Messages.Message>()
        ...
        {
            this.CreateMap<Domain.User, DTO.Users.UserReference>()
