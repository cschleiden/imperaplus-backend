...
var country5 = new CountryTemplate("5", "BRD") { X = 174, Y = 416 };
mapTemplate.Countries.Add(country5);
var country6 = new CountryTemplate("6", "DDR") { X = 307, Y = 327 };
mapTemplate.Countries.Add(country6);
var country7 = new CountryTemplate("7", "Denmark") { X = 301, Y = 417 };
mapTemplate.Countries.Add(country7);
var country8 = new CountryTemplate("8", "Norway") { X = 495, Y = 507 };
mapTemplate.Countries.Add(country8);
var country9 = new CountryTemplate("9", "Sweden") { X = 33, Y = 446 };
mapTemplate.Countries.Add(country9);
var country10 = new CountryTemplate("10", "Finland") { X = 130, Y = 462 };
mapTemplate.Countries.Add(country10);
var country11 = new CountryTemplate("11", "Cz. Rep") { X = 13, Y = 602 };
...
var country13 = new CountryTemplate("13", "Kalingrad") { X = 67, Y = 592 };
mapTemplate.Countries.Add(country13);
var country14 = new CountryTemplate("14", "Slov.") { X = 37, Y = 694 };
mapTemplate.Countries.Add(country14);
var country15 = new CountryTemplate("15", "Hung.") { X = 72, Y = 653 };
mapTemplate.Countries.Add(country15);
var country16 = new CountryTemplate("16", "Serbia") { X = 249, Y = 585 };
mapTemplate.Countries.Add(country16);
var country17 = new CountryTemplate("17", "Romania") { X = 292, Y = 625 };
mapTemplate.Countries.Add(country17);
var country18 = new CountryTemplate("18", "Moldova") { X = 355, Y = 619 };
mapTemplate.Countries.Add(country18);
var country19 = new CountryTemplate("19", "Bulgaria") { X = 403, Y = 576 };
mapTemplate.Countries.Add(country19);
var country20 = new CountryTemplate("20", "Ukraine") { X = 602, Y = 811 };
mapTemplate.Countries.Add(country20);
var country21 = new CountryTemplate("21", "Belarus") { X = 1363, Y = 925 };
mapTemplate.Countries.Add(country21);
var country22 = new CountryTemplate("22", "Lith.") { X = 1903, Y = 697 };
mapTemplate.Countries.Add(country22);
var country23 = new CountryTemplate("23", "Latavia") { X = 352, Y = 1075 };
mapTemplate.Countries.Add(country23);
var country24 = new CountryTemplate("24", "Est.") { X = 799, Y = 1278 };
mapTemplate.Countries.Add(country24);
var country25 = new CountryTemplate("25", "Turkey") { X = 285, Y = 715 };
mapTemplate.Countries.Add(country25);
var country26 = new CountryTemplate("26", "Syria") { X = 230, Y = 852 };
mapTemplate.Countries.Add(country26);
var country27 = new CountryTemplate("27", "Iraq") { X = 146, Y = 828 };
mapTemplate.Countries.Add(country27);
var country28 = new CountryTemplate("28", "Kuwait") { X = 56, Y = 813 };
mapTemplate.Countries.Add(country28);
var country29 = new CountryTemplate("29", "Iran") { X = 0, Y = 711 };
mapTemplate.Countries.Add(country29);
var country30 = new CountryTemplate("30", "Saudi Arabia") { X = 14, Y = 861 };
mapTemplate.Countries.Add(country30);
var country31 = new CountryTemplate("31", "Georgien") { X = 61, Y = 1093 };
mapTemplate.Countries.Add(country31);
var country32 = new CountryTemplate("32", "Armenien") { X = 45, Y = 1285 };
mapTemplate.Countries.Add(country32);
var country33 = new CountryTemplate("33", "Azerbaijan") { X = 85, Y = 1429 };
mapTemplate.Countries.Add(country33);
var country34 = new CountryTemplate("34", "Turkmenistan") { X = 55, Y = 1636 };
mapTemplate.Countries.Add(country34);
var country35 = new CountryTemplate("35", "Uzbekistan") { X = 121, Y = 1560 };
mapTemplate.Countries.Add(country35);
var country36 = new CountryTemplate("36", "Afghanistan") { X = 319, Y = 1568 };
mapTemplate.Countries.Add(country36);
var country37 = new CountryTemplate("37", "Tajikistan") { X = 289, Y = 1189 };
mapTemplate.Countries.Add(country37);
var country38 = new CountryTemplate("38", "Kyrgyzstan") { X = 264, Y = 1228 };
mapTemplate.Countries.Add(country38);
var country39 = new CountryTemplate("39", "Pakistan") { X = 310, Y = 1249 };
mapTemplate.Countries.Add(country39);
var country40 = new CountryTemplate("40", "Wolograd") { X = 554, Y = 1468 };
mapTemplate.Countries.Add(country40);
var country41 = new CountryTemplate("41", "Kazakhstan") { X = 687, Y = 1459 };
mapTemplate.Countries.Add(country41);
var country42 = new CountryTemplate("42", "Moscow district") { X = 657, Y = 1628 };
mapTemplate.Countries.Add(country42);
var country43 = new CountryTemplate("43", "Yakutia") { X = 861, Y = 1670 };
mapTemplate.Countries.Add(country43);
var country44 = new CountryTemplate("44", "Siberia") { X = 842, Y = 1576 };
mapTemplate.Countries.Add(country44);
var country45 = new CountryTemplate("45", "Japan") { X = 876, Y = 1518 };
mapTemplate.Countries.Add(country45);
var country46 = new CountryTemplate("46", "South Korea") { X = 1502, Y = 1594 };
mapTemplate.Countries.Add(country46);
var country47 = new CountryTemplate("47", "North Korea") { X = 1488, Y = 1372 };
mapTemplate.Countries.Add(country47);
var country48 = new CountryTemplate("48", "China") { X = 2123, Y = 1389 };
mapTemplate.Countries.Add(country48);
var country49 = new CountryTemplate("49", "Mongolia") { X = 2210, Y = 1465 };
mapTemplate.Countries.Add(country49);
var country50 = new CountryTemplate("50", "Austria") { X = 2420, Y = 1325 };
