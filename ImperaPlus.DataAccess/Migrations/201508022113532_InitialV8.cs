    ...
    public partial class InitialV8 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Alliances", t => t.Alliance_Id)
                .ForeignKey("dbo.Alliances", t => t.Alliance_Id1)
                .Index(t => t.AllianceId)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.Alliance_Id)
                .Index(t => t.Alliance_Id1);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Games", t => t.Id, cascadeDelete: true)
                .Index(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.NewsEntries", t => t.NewsEntry_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Maps", "Id", "dbo.Games");
            ...
            DropForeignKey("dbo.Games", "CurrentPlayerId", "dbo.Players");
            ...
            DropIndex("dbo.Games", new[] { "CurrentPlayerId" });
